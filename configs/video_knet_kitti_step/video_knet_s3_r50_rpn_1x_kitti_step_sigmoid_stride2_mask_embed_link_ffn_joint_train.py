...
custom_imports = dict(
    imports=[
        ...
        'knet.cross_entropy_loss', 'swin.swin_transformer',
        'swin.mix_transformer', 'swin.DetectRS', 'swin.swin_transformer_rfp',
        'external.cityscapes_step', 'external.kitti_step_dvps',
